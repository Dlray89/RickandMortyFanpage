...
export default function CharacterList(props) {
  ...
  return (
    <StyledHeader className="character-list">
        ...
        <div>
        <StyledNav><Link style={{textDecoration:"none", color: 'black', fontSize:'20px'}} to={"/"}>Home</Link></StyledNav>
        ...
        {characters.map( character => {
            return <CharacterCard character={character} key={character.id} href={character.image} />
        })}
        </StyleContainer>
